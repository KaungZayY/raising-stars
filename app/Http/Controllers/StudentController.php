...
class StudentController extends Controller
{
    ...
    public function info($id)
    {
        ...
        return view('student.student-info',compact('student','studentInfo'));
    }

    public function edit(User $user)
    {
        return view('student.student-edit',['student'=>$user]);
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        try
        {
            ...
            DB::commit();
            return redirect()->route('student')->with('success', 'Information has Updated');
        }
        catch(\Exception $e)
        {
            DB::rollBack();
    ...
    public function destroy(User $user)
    {
        ...
        {
            DB::rollBack();
            return redirect()->route('student')->with('error','Cannot Remove this User');
        }
        else
        {
            return redirect()->route('student')->with('success','User Archived');
        }
    }

    public function archives()
    {
        $students = User::onlyTrashed()->where('role_id',1)->get();
        return view('student.student-archives',['students'=>$students]);
    }
    ...
    public function restore($id)
    {
        ...
        $student->restore();
        return redirect()->route('student.archives')->with('success','User Restored');
    }
    ...
    public function forcedelete($id)
    {
        $student = User::withTrashed()->findOrFail($id);
        $student->forcedelete();
        return redirect()->route('student.archives')->with('success','User Removed Permanently');
    }
                ...
                foreach ($students as $key => $student) {
                    ...
                    '<tr>'.
                        ...
                        '<td class="py-2 px-4 border-b text-center">'.
                            ...
                            <span class="ml-2 mr-2">|</span>'.
                            '<div class="inline-block">'.
                                '<form action="'.route('student.delete',$student->id).'" method="POST" onsubmit="return confirm(\'Move this Data to Archives?\');">' .
