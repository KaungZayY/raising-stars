                ...
                <table class="min-w-full bg-white border border-gray-300 border-separate">
                  <thead>
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b bg-gray-300">Lecturers</th>
                  ...
                  <tbody>
                    @if ($modules->count())
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b text-center">{{$module->subject_id}}</td>
                            <!-- Lecturers -->
                            ...
                            <td class="py-2 px-4 border-b text-center">{{$module->deleted_at}}</td>
                            <td class="py-2 px-4 border-b text-center">
                                <div class="inline-block">
                                    <form action="{{route('module.restore',$module->id)}}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <button>
                                ...
                                <div class="inline-block">
                                    <form action="{{route('module.forcedelete',$module->id)}}" method="POST" onsubmit="return confirm('Are You Sure to Remove this Data?');">
                                        @csrf
                                        @method('DELETE')
                                        <button>
