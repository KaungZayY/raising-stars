            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{route('module.store')}}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="module_number" id="module_number" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500" required placeholder="Eg - M-01">
                    </div>
