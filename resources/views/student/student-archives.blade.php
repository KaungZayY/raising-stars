                  ...
                  <tbody>
                    @if ($students->count())
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b text-center">{{$student->deleted_at}}</td>
                            <td class="py-2 px-4 border-b text-center">
                                ...
                                <div class="inline-block">
                                    <form action="{{route('student.forcedelete',$student->id)}}" method="POST" onsubmit="return confirm('Are You Sure to Remove this Data?');">
                                        @csrf
                                        @method('DELETE')
                                        <button>
