    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-row justify-start">
                <form action="{{route('student.archives')}}" method="GET">
                    <button>
                ...
                <table class="min-w-full bg-white border border-gray-300 border-separate">
                  <thead class="with-larasort">
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b bg-indigo-400">@sortableLink('name', 'Name')</th>
                        <th class="py-2 px-4 border-b bg-indigo-400">@sortableLink('email', 'Email')</th>
                        <th class="py-2 px-4 border-b bg-indigo-400">@sortableLink('phone_number', 'Phone Number')</th>
                        <th class="py-2 px-4 border-b bg-indigo-400">@sortableLink('address', 'Address')</th>
