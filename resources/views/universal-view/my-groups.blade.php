                ...
                @if ($groups->count())
                    @foreach ($groups as $group)
                        <div class="w-1/2 text-center">
                            <div class="flex flex-col justify-center m-3 bg-fuchsia-400 dark:bg-fuchsia-200 rounded-lg border border-gray-200" onclick="viewGroup('{{route('group.view',$group)}}')">
