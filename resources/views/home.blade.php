                    ...
                    @if ($posts->count())
                        ...
                        <div class="bg-grey-200 dark:bg-gray-800 shadow-sm sm:rounded-lg">
                            ...
                            <div class="flex flex-row mt-2 mb-2 ml-2 justify-between">
                                <button class="basis-1/2 mb-4 flex items-center justify-center" onclick="postLiked({{$post->id}},{{Auth::user()->id}})">
                                ...
                                <button class="basis-1/2 mb-4 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="0 0 512 512">
