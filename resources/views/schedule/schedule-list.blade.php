    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-row justify-between">
                <form action="{{route('schedule.archives')}}" method="GET">
                    <button>
                ...
                @if ($schedules->count())
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b text-center">
                            ...
                            <span class="ml-2 mr-2">|</span>
                            <div class="inline-block">
                                <form action="{{route('schedule.delete',$schedule->id)}}" method="POST" onsubmit="return confirm('Move this Data to Archives?');">
                                    @csrf
                                    @method('DELETE')
                                    <button>
