                ...
                <table class="min-w-full bg-white border border-gray-300 border-separate">
                  <thead>
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b bg-gray-300">Duration</th>
                    ...
                    @if ($schedules->count())
                        ...
                        <td class="py-2 px-4 border-b text-center">{{$schedule->course->course}}</td>
                            <td class="py-2 px-4 border-b text-center">
                                ...
                                <div class="inline-block">
                                    <form action="{{route('schedule.forcedelete',$schedule->id)}}" method="POST" onsubmit="return confirm('Are You Sure to Remove this Data?');">
                                        @csrf
                                        @method('DELETE')
                                        <button>
