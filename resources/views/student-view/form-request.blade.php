    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-3 flex flex-row justify-center">
                <input type="text" name="search" id="search" class="w-1/3 px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500" placeholder="Search by Course..&#x1F50E;&#xFE0F; "/>
            </div>
                        ...
                        <td class="py-2 px-4 border-b text-center">
                            <div class="inline-block">
                                <form action="#" method="GET">
                                    <!-- when imp this, don't forget to update in search fun -->
                                    <button>
