                ...
                <table class="min-w-full bg-white border border-gray-300 border-separate">
                  <thead>
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b bg-gray-300">Age</th>
                  ...
                  <tbody>
                    @if ($courses->count())
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b text-center">{{$course->deleted_at}}</td>
                            <td class="py-2 px-4 border-b text-center">
                                ...
                                <div class="inline-block">
                                    <form action="{{route('course.forcedelete',$course->id)}}" method="POST" onsubmit="return confirm('Are You Sure to Remove this Data?');">
                                        @csrf
                                        @method('DELETE')
                                        <button>
