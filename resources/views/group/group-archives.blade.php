                ...
                <table class="min-w-full bg-white border border-gray-300 border-separate">
                  <thead>
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b bg-gray-300">Group Name</th>
                        <th class="py-2 px-4 border-b bg-gray-300">Description</th>
                  ...
                  <tbody>
                    @if ($groups->count())
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b text-center">{{$group->deleted_at}}</td>
                            <td class="py-2 px-4 border-b text-center">
                                ...
                                <div class="inline-block">
                                    <form action="{{route('group.forcedelete',$group->id)}}" method="POST" onsubmit="return confirm('Are You Sure to Remove this Data?');">
                                        @csrf
                                        @method('DELETE')
                                        <button>
